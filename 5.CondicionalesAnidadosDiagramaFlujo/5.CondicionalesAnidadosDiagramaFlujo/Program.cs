...
namespace _5.CondicionalesAnidadosDiagramaFlujo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //b.   Diseñar un algoritmo que lea tres número A,B,C y visualice en pantalla el valor más grande. El usuario debe ingresar tres valores diferentes.
            int num1 = 0;
            int num2 = 0;
            int num3 = 0;
            ...
            {   //Verdadera
                if (num1 > num3)
                {
                    Console.WriteLine("El número1 es el mayor");
                }
                else
                {
